...
\begin{minipage}[t]{0.7\textwidth} % 40% of the page width for the introduction text
    ...
    \colorbox{black}{\textcolor{white}{Experience: 10 years (3 Rust)}}
    \newline{}
    ...
    \newline{}
    \newline{}
     Driven to expand my expertise in back-ends, concurrency and async runtimes. Very curious by nature, always seeking to learn new things and I never back down from a challenge.\newline{}
