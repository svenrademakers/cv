...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Sven}}}}} % First name
	
	\colorbox{black}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Rademakers}}}}} % Last name
...
\begin{minipage}[t]{0.3\textwidth} % 50% of the page for the skills bar chart
	\vspace{-\baselineskip} % Required for vertically aligning minipages
    \includegraphics[height=3cm]{Sven.png}
\end{minipage}
