...
\includegraphics[width=4cm, align=0cm]{Sven.png} &
	\begin{cventries}
        ...
        \item{Summary: 10 years experience. C++, Rust, Embedded, Linux. }
        ...
        \item{My goal in my career is to become a leading expert on engineering
            practises and technology. It would be a plus if i could expand my knowledge in Rust, concurrency and async runtimes.}
